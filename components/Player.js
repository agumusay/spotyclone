		...
		<>
			...
			{/* <div className='bg-[#181818] flex items-center justify-between px-5 py-2.5 rounded-t-2xl relative space-x-20 md:space-x-0 overflow-x-scroll md:overflow-x-hidden scrollbar-hide'>
				<div className='flex items-center'>
					<img src={playingTrack.albumUrl} alt='' className='mr-3 h-14 rounded-xl' />
					<div>
						<h4 className='text-white text-sm max-w-[150px] md:max-w-[250px] truncate'>{playingTrack.title}</h4>
						<h5 className='text-xs text-[rgb(179,179,179)]'>{playingTrack.artist}</h5>
					</div>
				</div>
